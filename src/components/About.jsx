        ...
        <div className="row g-5 align-items-center">
          ...
          <div className="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
            ...
            <p className="mb-4" style={{ fontSize: "18px" }}>
              ...
              in India and partnerships across the Middle East, Europe, we deliver
              workforce solutions that meet the highest international standards.
            </p>

            <p className="mb-4" style={{ fontSize: "18px" }}>
              Our approach combines precision recruitment, ethical practices, and a deep
              understanding of industry demands.
            </p>
            ...
            <div className="row g-3 mb-4">
              ...
              <div className="col-12 d-flex">
                ...
                <div className="ms-4">
                  ...
                  <span style={{ fontSize: "18px" }}>
                    To connect exceptional talent with reputable global employers through
              ...
              <div className="col-12 d-flex">
                ...
                <div className="ms-4">
                  ...
                  <span style={{ fontSize: "18px" }}>
                    To become a leading international manpower partner known for reliability,
